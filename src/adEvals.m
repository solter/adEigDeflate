##-*- texinfo -*-
##@deftypefn{Function File} {[@var{H}, @var{spSt}, @var{spEnd}, @var{pltNum}] =} evals(@var{A},@var{topshifts})
##@deftypefnx{Function File} {[@var{H}, @var{spSt}, @var{spEnd}, @var{pltNum}] =} evals(@var{A},@var{topshifts},@var{toplt})
##@deftypefnx{Function File} {[@var{H}, @var{spSt}, @var{spEnd}, @var{pltNum}] =} evals(@var{A},@var{topshifts},@var{toplt},@var{toprt})
##@deftypefnx{Function File} {[@var{H}, @var{spSt}, @var{spEnd}, @var{pltNum}] =} evals(@var{A},@var{topshifts},@var{toplt},@var{toprt},@var{spike})
##
...
##    creating the spikes@*
## @end deftypefn
function [H, pltNum] = adEvals(H, Shifts, toplt = false, toprt = false, spike = true)
